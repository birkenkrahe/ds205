...
Download the raw exercise file from [[http://tinyurl.com/R-switch-practice][tinyurl.com/R-switch-practice]] and
...
flag in the =#+PROPERTY:= header of the Org-mode file.
