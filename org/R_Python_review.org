...
- To see, which packages are currently loaded in your session, use
  ...
  #+RESULTS:
  :  [1] ".GlobalEnv"        "ESSR"              "package:stats"     "package:graphics"  "package:grDevices" "package:utils"    
...
- We can print all =items= as a comprehension (an implicit loop):
  ...
  ('__PYTHON_EL_eval', <function __PYTHON_EL_eval at 0x7f41619896c0>)
  ('__PYTHON_EL_eval_file', <function __PYTHON_EL_eval_file at 0x7f4161989750>)
  ('__PYTHON_EL_native_completion_setup', <function __PYTHON_EL_native_completion_setup at 0x7f41619897e0>)
  ('__org_babel_python_tmpfile', <_io.TextIOWrapper name='/tmp/babel-Lbssab/python-q4H3gc' mode='r' encoding='UTF-8'>)
  ('variable_name', 'name')
  ('value', '__name__')
  ('_', ('__name__', '__main__'))
  ('i', ('__name__', '__main__'))
  ...
  ('read_csv', <function read_csv at 0x7f4153155bd0>)
  ('url', 'http://tinyurl.com/grades-csv')
  ...
  ('output_file_path', 'grades.csv')
  ('response', <http.client.HTTPResponse object at 0x7f4152fa3e80>)
  ('lines', ['ID,Test 1,Test 2\n', '1433,4.83,10\n', '1447,13,11\n', '1421,16.33,8.5\n', '1488,19.07,14.5\n', '2157,16.83,12\n', '1380,10,9.5\n', '1466,18,10.33\n', '1485,15.5,10.67\n', '646,16.83,13\n', '1136,17.5,9.67\n', '1654,11.5,10.67\n', '2130,15.83,10.33\n', '1916,17,10.5\n', '1377,,3.5\n', '1459,16.33,10.17\n', '1504,17.5,9.5\n', '779,17.5,12.5\n', '1329,16.74,12\n', '1295,17.33,8.17\n', '753,16.83,11.33\n', '1292,,9.5\n', '2190,,'])
  ('csvfile', <_io.TextIOWrapper name='grades.csv' mode='r' encoding='UTF-8'>)
  ('writer', <_csv.writer object at 0x7f4152fb7ee0>)
  ('line', '2190,,')
  ('reader', <csv.DictReader object at 0x7f4152fa3970>)
...
- Then use the index method to define the flag vector:
  ...
  #+RESULTS:
  : Error in df$ID : object of type 'closure' is not subsettable
...
- Use the flag vector to index the dataframe, remove the record and
  ...
  #+begin_example
  Error in df$ID : object of type 'closure' is not subsettable
  Error in which(idx) : object 'idx' not found
  Error in which(idx) : object 'idx' not found
  function (x, df1, df2, ncp, log = FALSE) 
  {
      if (missing(ncp)) 
...
- These functions can be expected to already take the presence of
  missing values into account. Let's check that for the average:
