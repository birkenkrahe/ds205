...
* Week 3: Python's Matplotlib & R factors & loops & function scope
#+ATTR_HTML: :WIDTH 600px:
[[../img/matplotlib.png]]

- [ ] Moved DataCamp lesson deadline to Feb 9
- [ ] Review: Entry test Python/R (practice sheet) & Emacs exercise (cont'd)
- [ ] DataCamp: Python's =matplotlib= (Wednesday)
- [ ] More fun facts! (Friday)
