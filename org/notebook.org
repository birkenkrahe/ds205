...
** DONE Create R graphics code blocks quickly
...
** DONE Review plotting histograms, barplots, tables
...
** DONE Continue "Plotting in R - histograms, barplots, boxplots" :progress:
