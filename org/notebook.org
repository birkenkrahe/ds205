...
- Python's =describe= completed
- Addendum to R's =summary= - don't use the ~ID~ column
- Plotting in R - histograms and boxplots

* Review plotting so far

To continue coding along, download, open and run: 
https://raw.githubusercontent.com/birkenkrahe/ds205/main/org/3_R_plots_codealong.org
...
1) Check that an R object (e.g. ~url~) was created.
   ...
   #+RESULTS:
   :  [1] "df"      "f"       "freq"    "freq_df" "freqs"   "names"   "t1"      "t2"      "tbl1"    "url"     "x"
...
7) barplot from table

8) turn table into dataframe
