...
** TODO Bonus: vectorized condition checks in Python
...
10. What are =&&= and =||= used for?
    #+begin_src R
      if (F || T) print("TRUE")
      if (T && T) print("TRUE again")
    #+end_src


** TODO if-else exercises: [[http://tinyurl.com/6-ifelse-practice-org][tinyurl.com/6-ifelse-practice-org]]
