...
* TODO Create R graphics code blocks quickly

1) ~M-x org-structure-template-alist~
2) ~Customize~
3) ~INS~ key: ~rg~, value: 
   #+begin_example
...
* TODO Review plotting histograms, barplots, tables
...
* TODO Continue "Plotting in R - histograms, barplots, boxplots"
