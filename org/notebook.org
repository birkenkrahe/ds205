...
* DONE Week 11: =switch= and =while= loops
#+attr_html: :width 400px:
[[../img/week_11.png]]
...
* DONE Week 12: =for= loops, =break=, =next=, and =repeat=
...
* DONE Week 13: Passing through: Python I
#+attr_html: :width 400px:
[[../img/week_13.png]]
...
* Week 14: Passing through Python II & Data processing in Shell
#+attr_html: :width 400px:
[[../img/week_14.png]]
...
Get the file with the latest progress from: tinyurl.com/python-from-scratch     
...
2. Create a repo ('main'/'origin')
3. Clone repo to local computer ('remote')
4. Add, commit and push remote (local) changes to main (origin)
...
Before attempting this, please complete the GitHub "hello world"
tutorial if you haven't done it yet: 

* Week 15: Integration of C++ and SQL with R and Python
