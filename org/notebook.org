...
* Week 13: Passing through: Python
#+attr_html: :width 400px:
[[../img/week_13.png]]

** TODO Practical Use case for =repeat=: continuous user input
...
** TODO Test 5 (R loops) is available until next Sunday

<<<<<<< HEAD


** TODO Data science from scratch with Python I-III
